export default [
  {
    ...
    comboboxes: [{
        ...
        EN_name: "Settlement",
        HE_name: "יישוב",
        source: `https://arcgis.intertown.co.il/krg_arcgis/rest/services/brn_general_vector/brn_general/MapServer/1`,
        field: 'SETL_NAME'
      },
      {
        cb_id: 2,
        EN_name: "Street",
        HE_name: "רחוב",
        source: 'https://arcgis.intertown.co.il/krg_arcgis/rest/services/brn_general_vector/brn_general/MapServer/2',
        field: 'STR_NAME',
        filters: [{
          id: 1,
          cb_id: 1,
