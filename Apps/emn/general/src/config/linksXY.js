...
export default [
  ...
  // {
  //   url: "https://simplex-smart3d.com/ces/azor/App-muni/index.html?&x=${this.x}&y=${this.y}&crs=2039",
  //   title_HE: `מבט 3D`,
  //   title_EN: '3D View',
  //   projection: "EPSG:2039"
  // },
  // {
  //   url: "http://simplex-mapping-data.com/oblivisionjs2/index.aspx?project=azur&x=${this.x}&y=${this.y}&crs=2039",
