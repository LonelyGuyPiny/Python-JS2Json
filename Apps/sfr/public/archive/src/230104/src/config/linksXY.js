...
export default [
  ...
  // },
  {
    url: "https://simplex-smart3d.com/ces/shafir/App-muni/index.html?&x=${this.x}&y=${this.y}&crs=2039&height=27",
    title_HE: `מבט 3D`,
    title_EN: '3D View',
    projection: "EPSG:2039"
  },
  {
    url: "http://simplex-mapping-data.com/oblivisionjs2/index.aspx?project=shafir&x=${this.x}&y=${this.y}&crs=2039",
