export default [
  ...
  {
    layerName: `קומפילציית מגרשים`,
    url: "https://hmd.bartech-net.co.il/show-form-results?planid=${this.plans_name}",
  ...
  {
    layerName: `חלקות`,
    url: "https://hmd.bartech-net.co.il/show-form-results?1=1&gushID=${this.GUSH_NUM}&helkaID=${this.PARCEL}",
    text: 'אתר הנדסי',
    type: 'URL'
  },
  {
  ...
  {
    layerName: `תוכניות`,
    url: "https://hmd.bartech-net.co.il/show-form-results?planid=${this.name}",
    text: 'אתר הנדסי',
    type: 'URL'
  },
  {
