export default [
  ...
  {
    layerName: `כל המגרשים`,
    url: "https://www.gezer-region.muni.il/show-form-results?&PlanID=${this.plans_name}",
    text: 'אתר הנדסי - תוכנית',
    type: 'URL'
  },
  {
    layerName: `קומפילציית יעודי קרקע`,
    url: "https://gis.intertown.co.il/share/bar/Getinfopage.php?itownsys=gzr&codetaba=${this.plans_name}&lotid=${this.lots_lot_num}",
    text: 'דף מידע',
    type: 'REQUEST'
  },
  {
  ...
  {
    layerName: `כל המגרשים`,
    url: "https://gzr.bartech-net.co.il/show-form-results?&PlanID=${this.plans_name}",
    text: 'אתר הנדסי - תוכנית',
    type: 'URL'
  },
  {
  ...
  {
    layerName: `תכניות`,
    url: "https://gzr.bartech-net.co.il/show-form-results?planid=${this.name}",
    text: 'אתר הנדסי',
    type: 'URL'
  },
  {
