export default [
  ...
  {
    layerName: `קומפילציה`,
    url: "https://nzr.bartech-net.co.il/show-form-results?&PlanID=${this.plan}",
  ...
  {
    layerName: `מגרשים היסטוריים`,
    url: "https://nzr.bartech-net.co.il/show-form-results?&PlanID=${this.plan_num}",
    text: 'אתר הנדסי - תוכנית',
    type: 'URL'
  },
  {
  ...
  {
    layerName: `חלקות`,
    url: "https://nzr.bartech-net.co.il/show-form-results?1=1&gush=${this.GUSH_NUM}&helka=${this.PARCEL}",
    text: 'אתר הנדסי',
    type: 'URL'
  },
  {
