...
export default [
  ...
  {
    url: "https://idan.ofek-air.com/oblivisionjs/index.aspx?project=maromhagalil&lat=${this.y}&lon=${this.x}&crs=4326",
    title_HE: `מבט אלכסוני`,
    title_EN: 'Oblique View',
    projection: "EPSG:4326"
  },
  {
    url: "https://oapgis.ofekonline.com/customscene/maromgalil/?locale=he&x=${this.x}&y=${this.y}",
    title_HE: `  מבט 3D`,
    title_EN: '3D View',
    projection: "EPSG:4326"
  },
