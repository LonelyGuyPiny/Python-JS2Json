...
class ExportMap extends Component {
  ...
  addDarwingLayers = (layerModuleObject) => {
    // console.log("layerModuleObject", layerModuleObject);
    const { drawingData, latestWkid, map, language } = this.props;
    ...
    if (drawingData) {
      ...
      features.forEach((f) => {
        ...
        // } else {
          // measurementValue = measurementHtml;
        // }
        // if((format === 'pdf' || format === 'PDF') && language === 'HE') {
        //   let measurementHtmlArr = measurementHtml.split(" ");
        //   const numberSplitArr = measurementHtmlArr[0].split(".");
        //   const measurementArr = measurementHtmlArr.length;
        //   let measurementHtmltext = '';
        //   if(measurementArr > 2) {
        //     measurementHtmlArr.forEach((text, i) => {
        //       if(i !== 0) {
        //         measurementHtmltext = measurementHtmltext + " " + text
        //       }
        //     })
        //   } else {
        //     measurementHtmltext = measurementHtmlArr[1]
        //   }
        //   let measureNumber = '';
        //   if(numberSplitArr[0].includes(',')) {
        //     const commaSplitArr = numberSplitArr[0].split(',');
        //     const commaSplitArrLen = commaSplitArr.length;
        //     let commaNumber = '';
        //     for(var i = commaSplitArrLen-1; i >= 0; i--) {
        //       if(i === commaSplitArrLen-1) {
        //         commaNumber = commaSplitArr[i]
        //       } else {
        //         commaNumber = commaNumber + "," + commaSplitArr[i]
        //       }
        //     }
        //     measureNumber = numberSplitArr[1] + "." + commaNumber;
        //   } else {
        //     measureNumber = numberSplitArr[1] + "." + numberSplitArr[0];
        //   }
        //   measurementValue = '\u202B' + measureNumber + " " + measurementHtmltext + '\u202C';
        // } else {
        //   measurementValue = measurementHtml;
        // }
        const flatCordinates = properties.geometry.flatCoordinates;
        // console.log("flatCordinates =>", flatCordinates);
        ...
        if (properties.shape && properties.shape === "Point") {
          ...
          // console.log('from to =>', toLonLat([flatCordinates[0], flatCordinates[1]], this.props.projection), toLonLat([flatCordinates[2], flatCordinates[3]], this.props.projection));
          // console.log('from reveser =>', this.props.projection, fromLonLat(toLonLat([flatCordinates[0], flatCordinates[1]]), this.props.projection));
          ...
          // console.log("final geometry", newArray);
          // return;
