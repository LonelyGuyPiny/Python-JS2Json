...
class LayerFilterMenu extends Component {
  ...
  render() {
    ...
    if (al && layer && layer.BoundingBox) {
      extlayer = {
        xmin: layer.BoundingBox[0].extent[0],
        ymin: layer.BoundingBox[0].extent[1],
        xmax: layer.BoundingBox[0].extent[2],
        ymax: layer.BoundingBox[0].extent[3]
      }
    }
        ...
        >
          <Block className="ulList">
            ...
            <List>
              ...
              {isVisible && !layer.groupname && menu.mainMenu.includes('layerRecords') &&
