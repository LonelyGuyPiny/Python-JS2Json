...
import { Fill } from './';
import { Outline } from './';
import { setBoxTab } from '../../../../redux/modules/drawing';
...
class Box extends Component {
  ...
  onBoxTabChange = (activeIndex) => {
    this.props.dispatch(setBoxTab(activeIndex));
    ...
    return (
      <Block className="drawShapes">
        ...
        <Tab
          ...
          onTabChange={(e, { activeIndex }) => this.onBoxTabChange(activeIndex)}
