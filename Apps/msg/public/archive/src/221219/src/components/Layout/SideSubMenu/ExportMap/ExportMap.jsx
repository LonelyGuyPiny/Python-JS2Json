...
class ExportMap extends Component {
  ...
  addDarwingLayers = (layerModuleObject) => {
    try {
      const { drawingData, latestWkid, map, language, translation } = this.props;
      ...
      if (drawingStoreData) {
        ...
        if (drawingStoreData.measureVectorFeatures.length > 0) {
          var measureFeatures = drawingData.measureVectorSource.getFeatures();
        } else {
          measureFeatures = [];
        }
        ...
        // return;
        // const measureFeatures = drawingStoreData.measureVectorFeatures;
