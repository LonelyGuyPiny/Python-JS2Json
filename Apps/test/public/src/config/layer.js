export default [
  ...
  // {
  //   url: 'https://stage1.intertown.co.il/arcgis/rest/services/gln_general_vector/gln_yk/MapServer',
  //   // export: ['kmz', 'GeoJSON', 'csv'],
  //   type:'arcgis'
  // },
  {
    url: 'https://stage1.intertown.co.il/arcgis/rest/services/gln_general_vector/gln_yeshuvim/MapServer',
    // export: ['kmz', 'GeoJSON', 'csv'],
    type:'arcgis'
  },
  {
  ...
  },
  {
    ...
    group: 'govmap:govmap_cadastre',
    export: ['shapezip', 'json', 'gml3', 'kml', 'excel', 'csv', 'convert']
  },
]