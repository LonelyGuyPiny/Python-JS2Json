...
export default [
  ...
  {
    url: "https://idan.ofek-air.com/oblivisionjs/index.aspx?project=egalil&lat=${this.y}&lon=${this.x}&crs=4326",
    title_HE: `צילום אלכסוני-אצבע הגליל`,
    title_EN: 'Oblique View',
    projection: "EPSG:4326"
  },
  {
    url: "https://idan.ofek-air.com/oblivisionjs/index.aspx?project=metula&lat=${this.y}&lon=${this.x}&crs=4326",
    title_HE: `צילום אלכסוני-מטולה`,
    title_EN: 'Oblique View',
    projection: "EPSG:4326"
  },
