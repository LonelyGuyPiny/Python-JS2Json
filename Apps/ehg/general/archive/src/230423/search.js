export default [
  
  {
   ...
   },
   {
    ...
    comboboxes: [{
        ...
        EN_name: "Block",
        HE_name: "גוש",
        source: `https://arcgis.intertown.co.il/krg_arcgis/rest/services/ehg_general_vector/ehg_cadaster/MapServer/1`,
        field: 'GUSH_NUM'
      },
      {
        cb_id: 2,
  ...
  comboboxes: [{
      ...
      EN_name: "Plan",
      HE_name: "תכנית",
      source: `https://arcgis.intertown.co.il/krg_arcgis/rest/services/ehg_general_vector/ehg_compilation/MapServer/1`,
      field: 'Taba_Name'
    },
    {
      cb_id: 2,
      ...
      source: 'https://arcgis.intertown.co.il/krg_arcgis/rest/services/ehg_general_vector/ehg_compilation/MapServer/7',
      field: 'Land_Use',
      filters: [{
        id: 1,
        cb_id: 1,
