...
export const setDwaingLayer = (data) => async (dispatch, getState, api) => {
  ...
  // store(`${basepath}-drawingData`, data);
  dispatch({ type: SET_LAYER, payload: data });
};

/**
 * @function
 * @name updateMeasurementsOnLangChange
 * @description
 * update the draw unit text on language change
 * @param {}
 * @returns {}
 */
...
/**
 * @function
 * @name updateMeasurementsOnUnitChange
 * @description
 * update the draw unit on unit change
 * @param {}
 * @returns {}
 */
...
/**
 * @function
 * @name setshowSegmentLength
 * @description
 * set the show Segment value for measure
 * @param {boolean} {value} val
 * @returns {boolean}
 */
export const setshowSegmentLength = (val) => async (dispatch) => {
  dispatch({
    type: SHOW_SEGMENT_LENGTH,
    payload: val
  })
  store(`${basepath}-showSeg`, val);
}

/**
 * @function
 * @name getshowSegmentLength
 * @description
 * get the show Segment value for measure
 * @param {boolean} {value} val
 * @returns {boolean}
 */
export const getshowSegmentLength = () => () => {
  // dispatch({
  //   type: SHOW_SEGMENT_LENGTH,
  //   payload: val
  // })
  return store(`${basepath}-showSeg`);
}
 ...
 * @name setStoreData
 * @description
 * set the store data for draw
 * @param {number} {data} data
 * @returns {}
 */
export const setStoreData = (data) => (dispatch) => {
 ...
 * @name getStoreData
 * @description
 * get the store data of draw
 * @param {number} {}
 * @returns {store data}
 */
export const getStoreData = () => () => {
  const data = store(`${basepath}-drawingData`);
  return data;
}

/**
 * @function
 * @name removeStoreData
 * @description
...
export const removeStoreData = () => async (dispatch) => {
  ...
  store.remove(`${basepath}-drawingData`);
}