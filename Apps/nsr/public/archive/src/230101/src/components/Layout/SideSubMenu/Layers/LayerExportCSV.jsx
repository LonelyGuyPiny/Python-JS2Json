...
import { create_CSV_MIDDLEWARE } from '../../../../middlewares/layers/layer_middleware';
...
class LayerExportCSV extends Component {
  ...
  componentDidMount = async () => {
    ...
    const middleware_data = {
      source: this.props.layer.type,
      layer: this.props.layer,
      type: 'csv',
    };
    const data = await create_CSV_MIDDLEWARE(middleware_data);
