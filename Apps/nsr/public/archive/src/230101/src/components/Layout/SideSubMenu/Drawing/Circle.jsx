...
import { Fill } from './';
import { Outline } from './';
import { setCircleTab } from '../../../../redux/modules/drawing';
...
class Circle extends Component {
  constructor(props) {
    ...
    this.state = {
      outline,
      fill,
      activeTabIndex: props.circleTab
    }
  }
  ...
  onCircleTabChange = (activeIndex) => {
    this.props.dispatch(setCircleTab(activeIndex));
    ...
    return (
      <Block className="drawShapes">
        ...
        <Tab
          ...
          onTabChange={(e, { activeIndex }) => this.onCircleTabChange(activeIndex)}
...
export default connect(
  state => ({
    ...
    circleTab: state.drawing.circleTab
  })
)(Circle);