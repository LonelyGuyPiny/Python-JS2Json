...
* @returns {export data}
*/
export const export_MIDDLEWARE = (data) => {
  switch (data.source) {
    case SOURCE.GEOSERVER:
      return export_GEOSERVER(data);
    default:
      return export_ARCGIS(data);
  }
}
 ...
 * @returns {export data}
 */
export const create_CSV_MIDDLEWARE = (data) => {
  switch (data.source) {
    case SOURCE.GEOSERVER:
      return create_CSV_GEOSERVER(data);
    default:
      return create_CSV_ARCGIS(data);
  }
}