...
export default [
  {
    ...
    title_HE: `מבט רחוב Google`,
    title_EN: 'Street view',
    projection: "EPSG:4326"
  },
  {
    url: "http://www.sol-israel.co.il/oblivisionjs/index.aspx?project=mcarmel&x=${this.x}&y=${this.y}&crs=2039",
  ...
  {
    url: "https://terravision.cct1.co.il/terraexplorerweb/MoradotHacarmel3DModel.html?position=${this.x},${this.y},1000,",
    title_HE: `מודל תלת מימד`,
    title_EN: '3D view',
    projection: "EPSG:4326"
  },
  {
